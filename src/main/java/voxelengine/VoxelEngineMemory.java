...
public class VoxelEngineMemory {
    public static void main(String[] args) {
        VoxelEngineMemory voxelEngine = new VoxelEngineMemory();
    ...
    VoxelEngineMemory() {
        ...
        this.world = new World(worldData.chunks, worldData.colors);
    }
                    ...
                    for (int z = 0; z < chunk.data[x][y].length; z++) {
                        ...
                        for (int i = 0; i < baseVoxel.faces.length; i++) {
                            ...
                            for (int j = 0; j < face.vertexPositions.length; j++) {
                                ...
                                vertices[verticesIndex++] = (float) ((int) chunk.data[x][y][z]);
                                vertices[verticesIndex++] = (float) face.normalIndex;
                            }
                        }
                    }
                }
    ...
    public void initShaders() {
        ...
        float[] colors = new float[this.world.uboColors.size() * 4];
        int colorIndex = 0;

        for (int i = 0; i < this.world.uboColors.size(); i++) {
            colors[colorIndex++] = this.world.uboColors.get(i).r;
            colors[colorIndex++] = this.world.uboColors.get(i).g;
            colors[colorIndex++] = this.world.uboColors.get(i).b;
    ...
    private static class BaseVoxel {
        ...
        public BaseVoxel() {
            ...
            this.faces = new VoxelFace[]{
                    new VoxelFace(0, frontPositions),
                    new VoxelFace(1, backPositions),
                    new VoxelFace(2, leftPositions),
                    new VoxelFace(3, rightPositions),
                    new VoxelFace(4, topPositions),
                    new VoxelFace(5, bottomPositions)
            };
        }
    }
    ...
    private static class VoxelFace {
        ...
        public VoxelFace(int normalIndex, Vector3[] vertexPositions) {
    ...
    private static class World {
        ...
        public List<VoxelEngineUtil.Color> uboColors;

        public World(List<VoxelEngineUtil.Chunk> chunks, List<VoxelEngineUtil.Color> uboColors) {
            this.chunks = chunks;
            this.uboColors = uboColors;
        }
    }
}
