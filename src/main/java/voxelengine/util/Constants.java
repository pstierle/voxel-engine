...
public final class Constants {
    ...
    public static final ExampleType WORLD_EXAMPLE = ExampleType.WORLD_NBT;
    ...
    //public static final NBTWorld NBT_WORLD = new NBTWorld("world/italy", new Vector3f(0f, 0f, 0f));
    ...
    public static final boolean OPTIMIZATION_INSTANCE_RENDERING = false;
    public static final boolean OPTIMIZATION_FACE_CULLING = false;
    public static final boolean OPTIMIZATION_SHADER_MEMORY = false;
    public static final boolean OPTIMIZATION_GREEDY_MESHING = false;
    public static final boolean OPTIMIZATION_FRUSTUM_CULLING = false;
}
