...
public class VoxelEngineInstanceRendering {
    public static void main(String[] args) {
        VoxelEngineInstanceRendering voxelEngine = new VoxelEngineInstanceRendering();
    ...
    public void initVertices() {
        ...
        int vertexCount = voxelCount * 9 * 4 * 6 /* estimate or calculate actual number of vertices */;
        final float[] vertices = new float[vertexCount];

        final int maxIndicesCount = voxelCount * 6 * 6;
        int[] indices = new int[maxIndicesCount];
        ...
        Log.info(String.format("Vertex count: %d", verticesIndex / 6));
